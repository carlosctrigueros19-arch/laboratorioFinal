...
public class Producto {
	    ...
	    private Categoria categoria; // Relación 1 a 1 con Categoria (clasifica)
	    ...
	    public String toString() {
	        return "Producto{" + "idProducto=" + idProducto + ", nombre=" + nombre + ", precioVenta=" + precioVenta + ", categoria=" + categoria.getNombre() + '}';
	    }
	}
